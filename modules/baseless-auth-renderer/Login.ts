								...
								<div>
									<div class="relative mt-6">
										<p class="text-sm text-gray-600">
											To keep connected with us please sign in with your personal information
										</p>
									</div>
									<div class="mt-4">
		...
		hasAnonymous && (`
			...
			<div class="relative hidden w-0 flex-1 lg:block">
				<svg
					...
					class="absolute inset-0 h-full w-full object-cover p-20"
					width="493.46111"
					height="480.84822"
				...
				>
					...
					<path
						...
						fill="#6c63ff"
					/>
					<rect y="72.78881" width="280.48127" height="277.59048" rx="26.74409" fill="#f2f2f2" />
					<path
						...
						fill="#fff"
					/>
					<path d="M556.96507,355.87588H429.5587a4.408,4.408,0,1,1,0-8.81605H556.96507a4.408,4.408,0,0,1,0,8.81605Z" transform="translate(-353.26944 -209.57589)" fill="#f2f2f2" />
					<path d="M556.96507,449.87588H429.5587a4.408,4.408,0,1,1,0-8.81605H556.96507a4.408,4.408,0,0,1,0,8.81605Z" transform="translate(-353.26944 -209.57589)" fill="#f2f2f2" />
					<path d="M608.70212,402.9067H377.82165a4.408,4.408,0,1,1,0-8.81606H608.70212a4.408,4.408,0,0,1,0,8.81606Z" transform="translate(-353.26944 -209.57589)" fill="#f2f2f2" />
					<polygon points="393.531 180.687 370.531 229.687 459.008 220.726 440.539 173.687 393.531 180.687" fill="#a0616a" />
					<polygon points="414.101 462.32 405.712 462.249 401.999 429.138 414.379 429.243 414.101 462.32" fill="#a0616a" />
					<path
					...
					<path
						...
						fill="#ccc"
					/>
					<circle cx="477.63839" cy="248.74781" r="9" fill="#6c63ff" />
					<path
					...
					<path
						...
						fill="#6c63ff"
					/>
					<path d="M638.915,495.45346h-189a15.5,15.5,0,0,0,0,31h189a15.5,15.5,0,1,0,0-31Z" transform="translate(-353.26944 -209.57589)" fill="#fff" />
					<path
						...
						fill="#6c63ff"
					/>
					<path d="M650.05955,563.09621H566.65319a4.408,4.408,0,1,1,0-8.81606h83.40636a4.408,4.408,0,0,1,0,8.81606Z" transform="translate(-353.26944 -209.57589)" fill="#6c63ff" />
				</svg>
			</div>
		</div>
	`;
