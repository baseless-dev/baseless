		...
		<div class="flex flex-row-reverse min-h-full">
			<div class="flex flex-1 flex-col justify-center py-12 px-4 sm:px-6 lg:flex-none lg:px-20 xl:px-24">
				<div class="mx-auto w-full max-w-sm lg:w-96">
					<div>
						<h2 class="my-6 text-5xl font-thin tracking-tight text-gray-900">Welcome back :)</h2>
						...
						<div>
							<form action="#" method="POST" class="space-y-6">
									...
									<div>
										...
										<div class="relative mt-1 rounded-md shadow-sm">
											...
											<input
												...
												name="email"
												id="email"
												class="block w-full appearance-none rounded-md border border-gray-300 px-3 py-2 pl-10 placeholder-gray-400 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm"
								...
								<div>
									<button
										type="submit"
										class="flex justify-center rounded-full border border-transparent bg-indigo-600 py-2 px-10 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
									>
										Sign in
									</button>
								</div>
						...
						<div class="mt-6">
							<div>
								...
								<div class="mt-4">
									<a
										href="#"
										class="inline-flex rounded-full justify-center rounded-md bg-white p-4 mr-2 text-sm font-medium text-gray-500 shadow-lg hover:bg-gray-50"
									>
