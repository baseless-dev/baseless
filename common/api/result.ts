import { InvalidApiResultDataError, InvalidApiResultError, InvalidApiResultErrorError } from "./errors.ts";
...
export function isApiResultData(value?: unknown): value is ApiResultData {
	return !!value && typeof value === "object" && "data" in value && typeof value.data === "object";
}

export function assertApiResultData(value?: unknown): asserts value is ApiResultData {
...
export function assertApiResultError(value?: unknown): asserts value is ApiResultError {
