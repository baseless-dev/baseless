...
export class DenoKVProvider extends KVProvider {
	...
	get(key: string, options?: KVGetOptions): Promise<KVKey> {
		return traced("@baseless/deno-provider.kv.get", {
			"kv.key": key,
	...
	put(key: string, value: unknown, options?: KVPutOptions): Promise<void> {
		return traced("@baseless/deno-provider.kv.put", {
			"kv.key": key,
	...
	list(options: KVListOptions): Promise<KVListResult> {
		return traced("@baseless/deno-provider.kv.list", {
	...
	delete(key: string): Promise<void> {
		return traced("@baseless/deno-provider.kv.delete", {
			"kv.key": key,
		}, (_span) => {
